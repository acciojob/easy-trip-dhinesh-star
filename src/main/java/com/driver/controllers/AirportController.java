...
public class AirportController {
    ...
    public String getLargestAirportName(){
        ...
        try{
            String response = airportService.getLargestAirportName();
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public double getShortestDurationOfPossibleBetweenTwoCities(@RequestParam("fromCity") City fromCity, @RequestParam("toCity")City toCity){
        ...
        try{
            double response = airportService.getShortestDurationOfPossibleBetweenTwoCities(fromCity,toCity);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
        ...
        try{
            ...
            int response = airportService.getNumberOfPeopleOn(date,airportName);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public int calculateFlightFare(@RequestParam("flightId")Integer flightId){
        ...
        try{
            int response = airportService.calculateFlightFare(flightId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public String bookATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        try{
            String response = airportService.bookATicket(flightId,passengerId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public String cancelATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        try{
            String response = airportService.cancelATicket(flightId,passengerId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public int countOfBookingsDoneByPassengerAllCombined(@PathVariable("passengerId")Integer passengerId){
        ...
        try{
            int response = airportService.countOfBookingsDoneByPassengerAllCombined(passengerId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public String addFlight(@RequestBody Flight flight){
        ...
        try{
            String response = airportService.addFlight(flight);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public String getAirportNameFromFlightId(@PathVariable("flightId")Integer flightId){
        ...
        try{
            String response = airportService.getAirportNameFromFlightId(flightId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public int calculateRevenueOfAFlight(@PathVariable("flightId")Integer flightId){
        ...
        try{
            int response = airportService.calculateRevenueOfAFlight(flightId);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
    ...
    public String addPassenger(@RequestBody Passenger passenger){
        ...
        try{
            String response = airportService.addPassenger(passenger);
            return response;
        }
        catch(Exception e){
            System.out.println(e.getMessage());
